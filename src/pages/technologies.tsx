...
function Tech() {
    ...
    return (
        ...
        <div className="w-screen h-screen md:w-auto bg-secondary font-poppins text-primary p-5 max-phone:flex max-phone:flex-col max-phone:place-items-center max-phone:h-100 max-phone:rounded-t-3xl max-phone:mb-8px">
