...
function About() {
    ...
    return (
        ...
        <div className="w-screen h-screen md:w-auto bg-primary font-poppins text-secondary ">
            <div className=''>
                <p className='font-regulrar p-16 text-2xl max-mobile:text-xl'>Sobre Mim</p>
            </div>
            <div className='flex flex-col justify-between item-start space-y-24 content-center px-16 text-2xl max-mobile:text-xl'>
