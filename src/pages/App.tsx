    ...
    <div className="w-screen h-screen max-phone:h-[400px] bg-primary p-5 font-atkinson max-phone:h-100">
      ...
      <div className='mt-20 -ml-20 flex flex-col items-center max-phone:ml-auto max-phone:mt-14'>
        ...
        <div className='flex justify-self-center items-baseline  gap-4 ml-16 -mt-10 drop-shadow-lg  max-laptop:ml-20 max-tablet:-mt-6 max-sm:-mt-4 max-sm:ml-10 max-sm:gap-2 max-phone:gap-1 max-phone:mr-10 max-phone:-mt-3'>
          ...
          <a href="https://bit.ly/4gikrSU"><img src="/Linkedin.svg" alt="Linkedin" className='w-20 max-tablet:w-16 max-tablet:w-16 max-phone:h-12 ' /></a>
          <a href="https://github.com/joaomidowz"><img src="/Github.svg" alt="GitHub" className='w-20 max-tablet:w-16 max-tablet:w-16 max-phone:h-12 ' /></a>
          <a href="https://bit.ly/3Cv2uPK"><img src="/GoogleDocs.svg" alt="Google Docs" className='w-18 max-tablet:w-16 max-tablet:w-16 max-phone:h-12 ' /></a>
          </div>
        </div>
