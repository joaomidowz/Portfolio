...
const scrollToSection = (id: string) => {
  ...
  return (
    ...
    <div className="w-screen h-screen bg-primary p-5 font-poppins ">
      ...
      <div className='mt-20 -ml-20 flex flex-col items-center max-phone:ml-auto'>

      <div className="w-full max-w-4xl flex justify-start mr-32 max-laptop:ml-56 max-tablet:-mr-20 max-mobile:-mr-0 max-sm:mr-6 max-phone:ml-24">
        ...
        <div className='flex justify-self-center items-baseline  gap-4 ml-28 -mt-10 drop-shadow-lg  max-laptop:ml-20 max-tablet:-mt-6 max-sm:mt-0 max-sm:ml-10 max-sm:gap-2 max-phone:gap-1 max-phone:ml-3'>
