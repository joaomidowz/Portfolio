    ...
    <div className="w-screen h-screen bg-primary p-5 font-poppins ">
      <header className='p-3'>
        <nav className='flex justify-end gap-10'>
          <button className='w-[150px] h-[60px] text-primary bg-secondary drop-shadow-md rounded-lg'>Sobre</button>
          <button className='w-[150px] h-[60px] text-primary bg-secondary drop-shadow-md rounded-lg '>Projetos</button>
          <button className='w-[150px] h-[60px] text-primary bg-secondary drop-shadow-md rounded-lg'>Tecnologias</button>
        </nav>
      </header>
      ...
      <div className="w-full max-w-4xl flex justify-start mr-32">
        ...
        <div className='flex justify-self-center items-baseline  gap-4 -mr-[45px] -mt-[40px] drop-shadow-xl  '>
