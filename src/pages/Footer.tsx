    ...
    return (
        <div className="h-96 w-screen  md:w-auto bg-primary font-poppins text-secondary p-20 flex flex-col justify-between items-center ">
            ...
            <div className='p-4 bg-secondary h-28 max-w-[970px] flex rounded-3xl justify-between items-center p-10 space-x-28'>
                ...
                <button className='w-32 h-12 bg-primary text-secondary italic font-medium text-lg rounded-2xl -mr-12 relative drop-shadow-2xl'><span className='text-shadow'>Copiar!</span></button>
                <span className='font-medium text-lg rounded-2xl bg-white h-12 w-96 flex items-center justify-center'>jgcustodio2005@gmail.com</span>    
                </div>
            </div>
